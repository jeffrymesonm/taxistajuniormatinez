...
(function () {
  ...
  var ES = {
    ...
    'rev.1.q': 'Junior es el mejor taxista de toda la República Dominicana. ¡Súper confiable y profesional!',
    'rev.1.a': 'Reseña de Google',
    'rev.2.q': 'Cuando visitamos República Dominicana, Junior es nuestra opción para todo el transporte. Lo conocemos desde hace casi 10 años y es muy confiable, con precios razonables. ¡Sigue así, Junior!',
    'rev.2.a': 'Reseña de Google · Cliente desde hace ~10 años',
    'rev.3.q': 'Excelente persona y un chofer muy hábil. Mi familia, mis amigos y yo lo hemos usado por años. Es el único taxista de la costa norte en quien confío para que nos lleve y nos traiga con seguridad.',
    'rev.3.a': 'Reseña de Google',
    'rev.4.q': 'Sin duda, el mejor taxi de la zona de Sosúa. Uso su servicio desde hace más de 10 años, en distancias largas y cortas. Su vehículo siempre está impecable y siempre llega puntual.',
    'rev.4.a': 'Reseña de Google · Cliente desde hace más de 10 años',
    'rev.5.q': 'Mi amigo Junior es el mejor del negocio. Vengo a la República Dominicana desde 2016 y es la única persona a la que llamo para que me recoja.',
    'rev.5.a': 'Reseña de Google · Cliente desde 2016',
    'rev.6.q': 'Uno de los taxistas más buenos y honestos de la zona de Sosúa / Cabarete / Puerto Plata. Llevo trabajando con Junior desde hace 3 años y lo recomiendo totalmente.',
    'rev.6.a': 'Reseña de Google · Cliente desde hace 3 años · Local Guide',
