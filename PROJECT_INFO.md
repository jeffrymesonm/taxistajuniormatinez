...
| Image slots | `assets/images/` — 16 files, see that folder's README |
| Cache busting | `?v=N` on the CSS and JS links; currently `v=9`. **Bump on every change** — a stale `?v` silently serves the old file. |
